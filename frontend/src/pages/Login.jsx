    ...
    <div className="h-full w-full flex items-center justify-center p-4 relative z-10 my-auto">
      ...
      >
        <div className="glass-panel p-8 rounded-3xl relative overflow-hidden group">
          {/* Animated glow */}
          <div className="absolute -top-32 -right-32 w-64 h-64 bg-amber-500/20 rounded-full blur-[80px] pointer-events-none group-hover:bg-amber-400/30 transition-colors duration-700" />
          
          <h2 className="text-3xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 relative z-10">
            Welcome Back
          </h2>
          <p className="text-zinc-400 mb-8 relative z-10">Sign in to access your captions.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            >
              {loading ? <Loader2 size={20} className="animate-spin" /> : (
                <>
                  Sign In <ArrowRight size={18} className="group-hover:tranzinc-x-1 transition-transform" />
                </>
              )}
            </button>
          </form>
